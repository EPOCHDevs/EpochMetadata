...
# 5-state example
regime = hmm_5(min_training_samples=1000)(returns, volatility, volume, momentum, sentiment)
# Access state_0_prob through state_4_prob
```
...
beta = beta(window=60)(stock_returns, spx_returns)
