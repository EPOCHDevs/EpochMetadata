...
**`quotes`, `trades`** - High-frequency bid/ask and trade execution data for intraday analysis.

**Applications:** Spread analysis, liquidity measurement, volume profiles, execution studies.
