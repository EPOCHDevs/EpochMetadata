...
<Callout type="info">
For detailed Smart Money Concepts (order blocks, liquidity, BOS/CHoCH, FVGs), see [ICT & Smart Money](../ict-smart-money) for complete working examples
</Callout>
...
<Callout type="tip">
Intraday strategies work best during high-liquidity sessions and benefit from tight risk management due to faster price movements.
</Callout>
