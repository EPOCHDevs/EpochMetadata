...
<Callout type="info">
Different market conditions require different strategies. Detect the regime first, then route to appropriate logic. For regime detection methods (trending vs ranging, volatility states, ADX/DMI, Vortex), see [Regime Detection](./regime-detection)
</Callout>
...
**Next:** [Guidelines & Best Practices](./guidelines)
