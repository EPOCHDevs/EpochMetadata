...
namespace glz
{
  ...
  struct to<JSON, decimal::Decimal>
  {
    ...
    static void op(const decimal::Decimal &x, auto &&...args) noexcept
    {
      ...
      else
      {
        ...
        serialize<JSON>::op<Opts>(epochflow::fromDecimal(x), args...);
      }
    }
  };
  ...
  struct from<JSON, decimal::Decimal>
  {
    ...
    static void op(decimal::Decimal &value, auto &&...args)
    {
      ...
      if (val.is_number())
      {
        value = epochflow::toDecimal(val.get_number());
      }
  ...
  template <>
  struct to<JSON, epochflow::Symbol>
  {
    template <auto Opts>
    static void op(const epochflow::Symbol &x, auto &&...args) noexcept
    {
  ...
  template <>
  struct from<JSON, epochflow::Symbol>
  {
    template <auto Opts>
    static void op(epochflow::Symbol &value, auto &&...args)
    {
      std::string human_readable;
      parse<JSON>::op<Opts>(human_readable, args...);
      value = epochflow::Symbol{human_readable};
    }
  };
