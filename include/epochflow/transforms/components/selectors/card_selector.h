...
class CardSelectorFromFilter : public epochflow::transform::ITransform {
public:
  explicit CardSelectorFromFilter(epochflow::transform::TransformConfiguration config)
...
private:
  static CardSchemaFilter GetSchemaFromConfig(const epochflow::transform::TransformConfiguration& config) {
