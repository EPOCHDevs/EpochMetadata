...
struct MetaDataOptionConstants {
  ...
  inline static std::vector<epochflow::SelectOption> SESSION_TYPE_OPTIONS = {
      {"Sydney", "Sydney"},
      {"Tokyo", "Tokyo"},
      {"London", "London"},
      {"NewYork", "NewYork"},
...
std::vector<epochflow::transforms::TransformsMetaData> MakePolygonDataSources();
std::vector<epochflow::transforms::TransformsMetaData> MakePolygonIndicesDataSources();
std::vector<epochflow::transforms::TransformsMetaData> MakeFREDDataSource();
} // namespace epochflow::transform

namespace YAML {
template <> struct convert<epochflow::transforms::IOMetaData> {
  static bool decode(const Node &node,
                     epochflow::transforms::IOMetaData &t) {
    t.decode(node);
    return true;
  }
};

template <> struct convert<epochflow::transforms::TransformsMetaData> {
  static bool decode(const Node &node,
                     epochflow::transforms::TransformsMetaData &t) {
    t.decode(node);
    return true;
  }
};
