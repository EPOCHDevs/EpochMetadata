...
inline auto no_operand_period_op(std::string const &op, auto &&id,
                                 int64_t period,
                                 epochflow::TimeFrame const &timeframe) {
...
inline auto bbands = [](std::string const &id, int period, int stddev,
                        ...
                        const epochflow::TimeFrame &timeframe) {
  YAML::Node inputs_yaml;
  inputs_yaml[epochflow::ARG] = input;
...
inline auto make_gap_classify_cfg =
    [](auto &&id, const epochflow::TimeFrame &timeframe) {
...
inline auto first_non_null = [](int64_t id, const std::vector<std::string> &inputs,
  ...
  // VARARGS inputs
  inputs_yaml["inputs"][epochflow::ARG] = inputs;
...
inline auto order_blocks =
    [](std::string const &id, std::string const &high_low,
       bool close_mitigation, const epochflow::TimeFrame &timeframe) {
...
inline auto retracements =
    [](std::string const &id, std::string const &high_low,
       std::string const &level, const epochflow::TimeFrame &timeframe) {
...
inline auto pivot_point_sr_cfg =
    [](std::string const &id, const epochflow::TimeFrame &timeframe) {
      YAML::Node config = YAML::Load(std::format(R"(
type: pivot_point_sr
id: {}
timeframe: {}
...
inline auto elders_thermometer_cfg =
    [](std::string const &id, int64_t period, double buy_factor,
       double sell_factor, const epochflow::TimeFrame &timeframe) {
      YAML::Node config = YAML::Load(std::format(
          R"(
...
inline auto scalar_aggregation_cfg =
    [](std::string const &agg_type, std::string const &id,
       std::string const &input, const epochflow::TimeFrame &timeframe,
       YAML::Node const &options = {}) {
      YAML::Node config;
...
inline auto hmm_cfg =
    [](std::string const &id, const std::vector<std::string> &inputs,
       const epochflow::TimeFrame &timeframe, int n_states = 3,
...
inline auto card_selector_filter_cfg =
    [](std::string const &id, epochflow::CardSchemaFilter const &card_schema,
       const std::vector<std::string> &inputs,
       const epochflow::TimeFrame &timeframe) {
      TransformDefinitionData data{
        .type = "card_selector_filter",
        .id = id,
        .options = {{"card_schema", epochflow::MetaDataOptionDefinition{epochflow::MetaDataOptionDefinition::T{card_schema}}}},
        .timeframe = timeframe,
        .inputs = {{"SLOT", inputs}}
      };
...
inline auto card_selector_sql_cfg =
    [](std::string const &id, epochflow::CardSchemaSQL const &card_schema,
       const std::vector<std::string> &inputs,
       const epochflow::TimeFrame &timeframe) {
      TransformDefinitionData data{
