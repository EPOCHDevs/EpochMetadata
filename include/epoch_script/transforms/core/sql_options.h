 ...
 */
inline const epoch_script::MetaDataOption SQL_OPTION{
    .id = "sql",
    .name = "SQL Query",
 ...
 */
inline const epoch_script::MetaDataOption TIMESERIES_SQL_OPTION{
    .id = "sql",
 ...
 */
inline const epoch_script::MetaDataOption ADD_INDEX_OPTION{
    .id = "add_index",
