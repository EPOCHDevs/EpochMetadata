...
namespace glz
{
  ...
  struct to<JSON, decimal::Decimal>
  {
    ...
    static void op(const decimal::Decimal &x, auto &&...args) noexcept
    {
      ...
      else
      {
        ...
        serialize<JSON>::op<Opts>(epoch_script::fromDecimal(x), args...);
      }
    }
  };
  ...
  struct from<JSON, decimal::Decimal>
  {
    ...
    static void op(decimal::Decimal &value, auto &&...args)
    {
      ...
      if (val.is_number())
      {
        value = epoch_script::toDecimal(val.get_number());
      }
  ...
  template <>
  struct to<JSON, epoch_script::Symbol>
  {
    template <auto Opts>
    static void op(const epoch_script::Symbol &x, auto &&...args) noexcept
    {
  ...
  template <>
  struct from<JSON, epoch_script::Symbol>
  {
    template <auto Opts>
    static void op(epoch_script::Symbol &value, auto &&...args)
    {
      std::string human_readable;
      parse<JSON>::op<Opts>(human_readable, args...);
      value = epoch_script::Symbol{human_readable};
    }
  };
