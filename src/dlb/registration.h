...
#define REGISTER_DLB_METADATA(FactoryMetaData)                                 \
  const int REGISTER_DLB_METADATA_##FactoryMetaData =                          \
      RegisterDLBMetaData(FactoryMetaData)

const std::vector SEQ_NODE_OPTIONS{
    MetaDataArgs{.id = "weight_init_type",
                 .name = "Weight Init Type",
                 .type = MetaDataArgType::Decimal,
                 .defaultValue = "",
                 .isRequired = true,
                 .values = {"orthogonal", "xavier_uniform", "xavier_normal",
                            "constant"}},
    MetaDataArgs{.id = "weight_init_gain",
                 .name = "Weight Init Gain",
                 .type = MetaDataArgType::Decimal},
    MetaDataArgs{.id = "bias_init",
                 .name = "Random State",
                 .type = MetaDataArgType::Decimal,
                 .defaultValue = "",
                 .isRequired = false},
    MetaDataArgs{.id = "activation",
                 .name = "Mode",
                 .type = MetaDataArgType::Select,
                 .defaultValue = "relu",
                 .isRequired = true,
                 .values = {"tanh", "relu", "leaky_relu", "sigmoid"}},
    MetaDataArgs{.id = "flatten",
                 .name = "Flatten",
...
std::vector DLB_RNN_OPTIONS{
    MetaDataArgs{.id = "hidden_size",
                 .name = "Hidden State Size",
                 .type = MetaDataArgType::Integer},
    MetaDataArgs{.id = "num_layers",
                 .name = "Num Layers",
                 .type = MetaDataArgType::Integer,
                 .defaultValue = "1"},
    MetaDataArgs{
        .id = "drop_out", .name = "Drop out", .type = MetaDataArgType::Decimal},
    MetaDataArgs{.id = "bidirectional",
                 .name = "Bi-Directional",
                 .type = MetaDataArgType::Boolean},
    MetaDataArgs{
        .id = "bias", .name = "Bias", .type = MetaDataArgType::Boolean},
    MetaDataArgs{.id = "nonlinearity",
                 .name = "Non Linearity",
                 .type = MetaDataArgType::Select,
                 .defaultValue = "",
                 .isRequired = false,
...
const DLBMetaData DLB_LSTM_METADATA{
    ...
    .nodeType = NodeConnectionType::OneToOne,
    .args = Merge(Merge(SEQ_NODE_OPTIONS, DLB_RNN_OPTIONS),
                  std::vector{MetaDataArgs{
                      MetaDataArgs{.id = "proj_size",
                                   .name = "Proj Size",
                                   .type = MetaDataArgType::Integer,
                                   .defaultValue = "0",
                                   .isRequired = false},
...
const DLBMetaData DLB_LINEAR_METADATA{.id = "Linear",
                                      .name = "Linear",
                                      .nodeType = NodeConnectionType::OneToOne,
...
std::vector DLB_EMBEDDING_OPTIONS{
    MetaDataArgs{
        .id = "in_features", .name = "Size", .type = MetaDataArgType::Integer},
    MetaDataArgs{.id = "padding_idx",
                 .name = "Padding Index",
                 .type = MetaDataArgType::Integer,
                 .defaultValue = "",
                 .isRequired = false},
    MetaDataArgs{.id = "max_norm",
                 .name = "Max Norm",
                 .type = MetaDataArgType::Integer,
                 .defaultValue = "",
                 .isRequired = false},
    MetaDataArgs{.id = "norm_type",
                 .name = "Norm Type",
                 .type = MetaDataArgType::Decimal,
                 .defaultValue = "",
                 .isRequired = false},
    MetaDataArgs{.id = "scale_grad_by_freq",
                 .name = "Scale Grad By Freq",
                 .type = MetaDataArgType::Boolean,
                 .defaultValue = "",
                 .isRequired = false},
    MetaDataArgs{.id = "sparse",
                 .name = "Sparse",
                 .type = MetaDataArgType::Boolean,
                 .defaultValue = "",
                 .isRequired = false}};
...
const DLBMetaData DLB_CONCAT_METADATA{.id = "Concat",
                                      .name = "Concat",
