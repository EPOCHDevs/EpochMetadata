...
namespace epoch_stratifyx::epochflow
{
    ...
    struct CompilationContext
    {
        ...
        const epoch_metadata::transforms::ITransformRegistry& GetRegistry() const
        {
            return epoch_metadata::transforms::ITransformRegistry::GetInstance();
        }

        // Helper to get component metadata
        const epoch_metadata::transforms::TransformsMetaData& GetComponentMetadata(const std::string& component_name) const
        {
