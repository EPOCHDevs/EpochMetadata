...
void ApplyDefaultTransform(const epoch_metadata::transform::ITransformBase &transformer,
                           ExecutionContext &msg);

// Apply a cross-sectional transform
void ApplyCrossSectionTransform(const epoch_metadata::transform::ITransformBase &transformer,
                                ExecutionContext &msg);
...
MakeExecutionNode(const epoch_metadata::transform::ITransformBase &transformer,
                 ExecutionContext &msg) {
