...
namespace stratifyx::metadata::ml_kit {
...
const int REGISTRATION_MLKIT_METADATA_##FactoryMetaData = RegisterMLKitMetaData(FactoryMetaData)

    const MLKitMetaData FRAC_DIFF_SCALAR_METADATA{
        .id = "frac_diff",
        .name = "Fractional Differentiation",
        .class_ = RegistryClass::Transformer,
        .args = std::vector<MetaDataArg>{
                MetaDataArg{
                .id = "n",
    ...
    const MLKitMetaData PCA_SCALAR_METADATA{
        ...
        .args = std::vector<MetaDataArg>{
                ...
                .values = {"Covariance Divide and Conquer Method", "Covariance Jacobi Method"},
                .isRequired = true
            },
                MetaDataArg{
                .id = "tol",
                ...
                .defaultValue = "1e-7",
                .type = MetaDataArgType::Decimal,
                .desc = "Tolerance for singular values computed by svd."
            },
                MetaDataArg{
                .id = "whiten",
                .name = "Whiten",
                ...
                .desc = "When true, the components are multiplied by the square root of n_samples and divided by the singular values."
            }
        },
    ...
    const MLKitMetaData STANDARD_SCALAR_METADATA{
        ...
        .desc = "Standardizes features by removing the mean and scaling to unit variance."
    };
    ...
    const std::vector<MetaDataArg> MLKIT_XGB_METADATA_ARGS{
            ...
            .defaultValue = "0",
            .type = MetaDataArgType::Decimal,
            .desc = "Minimum loss reduction required to make a further partition on a leaf node."
        },
            MetaDataArg{
            .id = "min_child_weight",
    ...
    const MLKitMetaData CUML_LOGISTIC_REGRESSION_METADATA{
        ...
        .args = std::vector<MetaDataArg>{
                ...
                .defaultValue = "1.0",
                .type = MetaDataArgType::Decimal,
                .desc = "Must be a positive float; smaller values specify stronger regularization."
            },
                MetaDataArg{
                .id = "fit_intercept",
                .name = "Fit Intercept",
                .defaultValue = "true",
                .type = MetaDataArgType::Boolean,
                .desc = "Specifies if a constant should be added to the decision function."
            },
                MetaDataArg{
                .id = "max_iter",
                ...
                .desc = "The Elastic-Net mixing parameter, with 0 <= l1_ratio <= 1."
            }
        },
    ...
    const MLKitMetaData DLB_MSE_METADATA{
        ...
        .desc = "Measures the average squared difference between inputs and targets."
    };
    ...
    const MLKitMetaData DLB_CROSS_ENTROPY_METADATA{
        ...
        .args = std::vector<MetaDataArg>{
                ...
                .defaultValue = "-100",
                .type = MetaDataArgType::Integer,
                .desc = "Specifies a target value that is ignored and does not contribute to the input gradient.",
                .isRequired = false
            },
                MetaDataArg{
                .id = "label_smoothing",
    ...
    const std::vector<MetaDataArg> DLB_ADAM_OPTIONS_METADATA{
        ...
        //     .type = MetaDataArgType::Decimal,
        //     .desc = "Coefficients used for computing running averages of gradient and its square."
        // },
        MetaDataArg{
            .id = "eps",
            .name = "Epsilon",
            .defaultValue = "1e-8",
            .type = MetaDataArgType::Decimal,
            .desc = "Term added to the denominator to improve numerical stability."
        },
            MetaDataArg{
            .id = "weight_decay",
            .name = "Weight Decay",
            ...
            .defaultValue = "false",
            .type = MetaDataArgType::Boolean,
            .desc = "Whether to use the AMSGrad variant of this algorithm."
        }
    };
    ...
    const MLKitMetaData DLB_LBFGS_METADATA{
        ...
        .args = std::vector<MetaDataArg>{
                ...
                .defaultValue = "25",
                .type = MetaDataArgType::Integer,
                .desc = "Maximum number of function evaluations per optimization step."
            },
                MetaDataArg{
                .id = "tolerance_grad",
                ...
                .defaultValue = "1e-5",
                .type = MetaDataArgType::Decimal,
                .desc = "Termination tolerance on first order optimality."
            },
                MetaDataArg{
                .id = "tolerance_change",
                ...
                .defaultValue = "1e-9",
                .type = MetaDataArgType::Decimal,
                .desc = "Termination tolerance on function value/parameter changes."
            },
                MetaDataArg{
                .id = "history_size",
                .name = "History Size",
    ...
    const MLKitMetaData DLB_STEP_LR_SCHEDULER_METADATA{
        ...
        .args = std::vector<MetaDataArg>{
                ...
                .defaultValue = "0.1",
                .type = MetaDataArgType::Decimal,
                .desc = "Multiplicative factor of learning rate decay."
            }
        },
        .desc = "Decays the learning rate of each parameter group by gamma every step_size epochs."
    };
