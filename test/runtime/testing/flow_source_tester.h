...
private:
     ...
     */
    static epoch_metadata::strategy::PythonSource LoadSource(const std::filesystem::path& sourceFile);
     ...
     */
    static bool IsCrossSectional(const epoch_metadata::strategy::PythonSource& source);
