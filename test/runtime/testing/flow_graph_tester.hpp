...
// #include <epoch_testing/yaml_transform_tester.hpp>  // Removed - YAML tester deprecated
// #include <epoch_testing/transform_tester_base.hpp>  // Removed - not needed for flow graph tests
...
struct FlowGraphTestCase {
    ...
    epoch_metadata::transform::TransformConfigurationList configuration;
...
epoch_metadata::transform::TransformConfigurationList loadConfigurationFromYAML(const YAML::Node& node);
...
public:
    ...
    static void runAllTests(
        ...
        std::function<std::pair<TimeFrameAssetDataFrameMap, AssetReportMap>(
            ...
            const epoch_metadata::transform::TransformConfigurationList&,
...
private:
    ...
    static std::pair<TimeFrameAssetDataFrameMap, AssetReportMap> runFlowGraphWithConfig(
        ...
        const epoch_metadata::transform::TransformConfigurationList& configuration,
