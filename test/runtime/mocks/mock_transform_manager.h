...
#include <runtime/transform_manager/itransform_manager.h>
...
public:
     ...
     */
    void AddTransform(std::unique_ptr<epoch_metadata::transform::ITransformBase> transform) {
    ...
    [[nodiscard]] const epoch_metadata::transform::TransformConfiguration*
...
private:
    mutable std::vector<std::unique_ptr<epoch_metadata::transform::ITransformBase>> m_transforms;
};
