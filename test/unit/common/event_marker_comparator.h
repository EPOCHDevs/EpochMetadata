...
public:
    using EventMarkerData = epoch_script::transform::EventMarkerData;
     ...
     */
    static std::string ToJson(const EventMarkerData& selector, bool prettyPrint = true);
     ...
     * @return JSON string representation
     */
    static std::string ToJson(const std::vector<EventMarkerData>& selectors, bool prettyPrint = true);
     ...
     */
    static void SaveJson(const std::vector<EventMarkerData>& selectors,
     ...
     * @return True if equal, false otherwise
     */
    static bool Compare(const std::vector<EventMarkerData>& expected,
