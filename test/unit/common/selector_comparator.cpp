...
std::string SelectorComparator::ToJson(const std::vector<SelectorData>& selectors,
                                      bool prettyPrint) {
...
void SelectorComparator::SaveJson(const std::vector<SelectorData>& selectors,
...
bool SelectorComparator::Compare(const std::vector<SelectorData>& expected,
